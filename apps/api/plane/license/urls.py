...
urlpatterns = [
    ...
    path("users/<uuid:pk>/", InstanceUserDetailEndpoint.as_view(), name="instance-user"),
    path("users/<uuid:pk>/oidc/", InstanceUserOidcEndpoint.as_view(), name="instance-user-oidc"),
]
